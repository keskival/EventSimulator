...
The model of the system is loosely based on a Youtube video of a real Flexible Assembly System. The work steps are catalogued and timed, and a discrete event simulation
...
The goal of the research project is to create a source for interesting data for modelling. To be interesting, the simulation implemented should roughly correspond to real
conditions, although it does not need to exactly replicate any specific existing system. The represented process traces should somehow show the failure conditions.
